                    ...
                    child: _loading
                        ...
                        : ListView(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  _StatCard(title: 'Demandes actives', value: _activeRequests.toString(), icon: Icons.assignment_outlined),
                                  const SizedBox(width: 12),
                                  _StatCard(title: 'Alertes de stock', value: _stockAlerts.toString(), icon: Icons.warning_amber_outlined, highlight: true),
                                ],
                              ),
                              const SizedBox(height: 12),
                              Row(
                                children: [
                                  _StatCard(title: 'Dons aujourd\'hui', value: _todayDonations.toString(), icon: Icons.volunteer_activism_outlined),
                                  const SizedBox(width: 12),
                              ...
                              Text('Mes annonces', style: GoogleFonts.ubuntu(fontSize: 16, fontWeight: FontWeight.w700)),
                              ...
                              if (_mine.isEmpty)
                                Container(
                                  ...
                                  child: Text('Aucune annonce publiée.', style: GoogleFonts.ubuntu(color: Colors.grey.shade700)),
                                )
                              else
                                ..._mine.map((a) {
