...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'ar_SA': {
      ...
      // BanquePage translations
      'available_blood_bags': 'أكياس الدم المتاحة',
      'find_blood_quickly': 'ابحث عن الدم بسرعة',
      'search_blood_bag_placeholder': 'ابحث عن كيس... مثال A+',
      'total_stock_available': 'إجمالي المخزون المتاح',
      'see_all': 'عرض الكل',
      'bags_available': 'كيس @count متاح|أكياس @count متاحة',
      'in_blood_banks': 'في بنك @count للدم|في بنوك @count للدم',
      'availability_by_blood_type': 'التوفر حسب فصيلة الدم',
      'bag': 'كيس',
      'bags': 'أكياس',
      'no_blood_type_available': 'لا توجد فصيلة دم متاحة',
      'no_bank_available': 'لا يوجد بنك متاح',
      ...
      'bank': 'بنك',
      'payment': 'الدفع',
      'bank_available_singular': 'بنك @count متاح',
      'bank_available_plural': 'بنوك @count متاحة',
      'distance_from_you': '@distance منك',
      'price_per_bag': '@price لكل كيس',
      'error_loading_bags': 'خطأ في تحميل الأكياس',
      'loading_available_bags': 'جارٍ تحميل الأكياس المتاحة...',
      'select_quantity': 'اختر الكمية',
      'bag_available_singular': 'كيس @count متاح',
      'bag_available_plural': 'أكياس @count متاحة',
      'creating_cart': 'جارٍ إنشاء السلة...',
      'preparing_order': 'جارٍ تحضير الطلب...',
      'confirm_order': 'تأكيد الطلب',
      'verify_and_pay': 'التحقق والدفع',
      ...
      'exchange_rate': 'سعر الصرف: 1 @from = @rate @to',
      'original': 'الأصلي',
      'converted': 'المحول',
      'submitting_payment': 'جارٍ إرسال الدفع...',
      ...
      'blood_bag': 'كيس دم',
      'receipt_downloaded': 'تم تنزيل الإيصال: @path',
      'generation_error': 'خطأ في الإنشاء: @error',
      'eblood_payment_receipt': 'إيصال دفع E-Blood',
      'receipt_subject': 'إيصال - @identifier',
      'share_error': 'خطأ في المشاركة: @error',
