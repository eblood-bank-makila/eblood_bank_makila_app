...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    // French translations
    'fr_FR': {
      // Missing-key sweep 2026-07-31 (raw keys were showing on screen)
      'accept_before_timeout': 'Acceptez avant l\'expiration du délai',
      'accept_delivery': 'Accepter la livraison',
      'active_delivery': 'Livraison en cours',
      'address_payment_history': 'Historique des paiements d\'adresse',
      'address_requests': 'Demandes d\'adresse',
      'arrived': 'Arrivé',
      'arrived_at_blood_bank': 'Arrivé à la banque de sang',
      'arrived_at_hospital': 'Arrivé à l\'hôpital',
      'at_blood_bank': 'À la banque de sang',
      'at_hospital': 'À l\'hôpital',
      'blood_picked_up': 'Sang récupéré',
      'call': 'Appeler',
      'confirm_delivery_message': 'Confirmez-vous avoir reçu la livraison de sang ?',
      'confirm_delivery_receipt': 'Confirmer la réception de la livraison',
      ...
      'delivery_arrived': 'Livraison arrivée',
      'delivery_driver': 'Livreur',
      'delivery_en_route': 'Livraison en route',
      'delivery_location': 'Lieu de livraison',
      'delivery_progress': 'Progression de la livraison',
      'demographics': 'Données démographiques',
      'destination': 'Destination',
      'eligibility': 'Éligibilité',
      'eligible': 'Éligible',
      'emergency_delivery': 'Livraison d\'urgence',
      'en_route_to_blood_bank': 'En route vers la banque de sang',
      'en_route_to_hospital': 'En route vers l\'hôpital',
      'error_confirming_delivery': 'Erreur lors de la confirmation de la livraison',
      'error_updating_status': 'Erreur lors de la mise à jour du statut',
      'error_with_message': 'Erreur : @error',
      'eta': 'Heure d\'arrivée estimée',
      'failed': 'Échoué',
      'gallery_access_error': 'Impossible d\'accéder à la galerie',
      'going_to_blood_bank': 'En direction de la banque de sang',
      'in_transit': 'En transit',
      'inactive_donors': 'Donneurs inactifs',
      'inactive_donors_count': 'Donneurs inactifs',
      'incoming_delivery': 'Livraison entrante',
      'ins_button_what': 'Qu\'est-ce que l\'INS ?',
      'ins_button_yes': 'Oui, je veux l\'INS',
      'ins_explain_body': 'L\'INS (Identifiant National de Santé) est un identifiant unique qui sécurise votre dossier médical et facilite vos soins dans tous les établissements de santé.',
      'ins_explain_hint': 'Vous pourrez toujours faire la demande plus tard depuis votre profil.',
      'ins_explain_title': 'À propos de l\'INS',
      'invalid_latitude': 'Latitude invalide',
      'invalid_longitude': 'Longitude invalide',
      'locations_loading': 'Chargement des localités...',
      'map_view': 'Vue carte',
      'max_length': 'Longueur maximale',
      'min_length': 'Longueur minimale',
      'my_activity': 'Mon activité',
      'new_delivery_request': 'Nouvelle demande de livraison',
      'no_active_delivery': 'Aucune livraison en cours',
      'no_address_requests': 'Aucune demande d\'adresse',
      'no_address_requests_desc': 'Vos demandes d\'adresse payées du jour apparaîtront ici',
      'no_form_fields': 'Aucun champ de formulaire à afficher',
      'no_hospital_selected': 'Aucun hôpital sélectionné',
      'no_pending_deliveries': 'Aucune livraison en attente',
      'no_pending_deliveries_desc': 'Vos livraisons en attente apparaîtront ici',
      'no_transactions': 'Aucune transaction',
      'no_transactions_desc': 'Vos transactions récentes apparaîtront ici',
      ...
      'photo_must_show_clear_face': 'La photo doit montrer clairement votre visage',
      'pickup': 'Retrait',
      'pickup_location': 'Lieu de retrait',
      'preparing_for_dispatch': 'Préparation pour l\'expédition',
      'qr_capture_failed': 'Échec de la capture du code QR',
      'qr_download_failed': 'Échec du téléchargement du code QR',
      'qr_extraction_not_implemented': 'L\'extraction du code QR n\'est pas encore disponible',
      'qr_saved': 'Code QR enregistré',
      ...
      'support_coming_soon': 'Le support arrive bientôt',
      'switch': 'Changer',
      'total': 'Total',
      'track': 'Suivre',
      'transactions': 'Transactions',
      'try_different_location': 'Essayez un autre emplacement',
      'update_status': 'Mettre à jour le statut',
      'validation_failed': 'Échec de la validation',
      'validity_duration_config_coming': 'La configuration de la durée de validité arrive bientôt',
      'version': 'Version',
      'visitor': 'Visiteur',
      'waiting_for_confirmation': 'En attente de confirmation',
      'app_information': 'Informations sur l\'application',
      'app_settings': 'Paramètres de l\'application',
      'choose_id_photo': 'Choisir la photo de la pièce d\'identité',
      'clear': 'Effacer',
      'clear_cache': 'Vider le cache',
      'contact_info': 'Coordonnées',
      'face_too_close': 'Le visage est trop proche. Reculez un peu de la caméra.',
      'face_too_small': 'Le visage est trop petit sur l\'image. Rapprochez-vous et centrez votre visage.',
      ...
      'id_scan_tip': 'Prenez une photo nette de votre document d\'identité (carte nationale, passeport ou permis de conduire). Assurez-vous qu\'il soit lisible, bien éclairé et entièrement visible.',
      'ins_button_what_sub': 'Comprendre l\'INS et ses avantages',
      'ins_button_yes_sub': 'Commencer votre demande d\'INS',
      'ins_step_id_scan': 'Scannez votre pièce d\'identité',
      ...
      'eblood_fee_label': 'Frais eBlood',
      'km_delivery_fee': 'Frais de distance',
      'km_delivery_fee_with_distance': 'Frais de distance (@distance km)',
      ...
      'select_payout_number': 'Choisir le numéro de cash-out',
      'no_validated_payout_number': 'Aucun numéro de cash-out validé. Ajoutez un numéro dans les paramètres et attendez sa validation par eBlood.',
      'cash_outs_title': 'Cash-outs',
      'no_cash_outs': 'Aucun cash-out pour ce portefeuille',
      'withdrawal_submitted': 'Demande de retrait soumise',
      'cash_out_status_pending': 'En attente',
      'cash_out_status_processing': 'En cours',
      'cash_out_status_withdrawn': 'Retiré',
      'cash_out_status_failed': 'Échoué',
      'cash_out_status_rejected': 'Rejeté',
      'auto': 'auto',
      'payout_numbers_title': 'Numéros de cash-out',
      'add_payout_number': 'Ajouter un numéro',
      'edit_payout_number': 'Modifier le numéro',
      'no_payout_numbers': 'Aucun numéro de cash-out enregistré',
      'payout_number_validation_note': 'Un numéro nouveau ou modifié est soumis à la validation eBlood',
      'payout_status_pending': 'En attente de validation',
      'payout_status_validated': 'Validé',
      'payout_status_rejected': 'Rejeté',
      'payout_status_disabled': 'Désactivé',
      'holder_name': 'Nom du titulaire',
      'operator': 'Opérateur',
      'daily_cap': 'Plafond journalier',
      'enter_valid_daily_cap': 'Veuillez saisir un plafond journalier valide (> 0)',
      'enter_valid_priority': 'Veuillez saisir une priorité valide (≥ 1)',
      'disable': 'Désactiver',
      'payout_number_saved': 'Numéro enregistré et soumis à la validation',
      'payout_number_deleted': 'Numéro supprimé',
      'payout_number_disabled': 'Numéro désactivé',
      'confirm_delete_payout_number': 'Voulez-vous vraiment supprimer ce numéro de cash-out ?',
      'wallet_origin_blood_request_payment_hold': 'Paiement bloqué (séquestre)',
      'wallet_origin_blood_request_escrow_release': 'Libération du séquestre',
      'wallet_origin_blood_bag_sale': 'Vente de poches de sang',
      'wallet_origin_cnts_commission': 'Commission CNTS',
      'wallet_origin_platform_flat_fee': 'Frais fixe plateforme',
      'wallet_origin_platform_percent_fee': 'Frais plateforme (%)',
      'wallet_origin_km_delivery_fee': 'Frais kilométriques',
      'wallet_origin_blood_request_refund': 'Remboursement',
      'wallet_origin_cash_out_debit': 'Cash-out',
      'wallet_origin_cash_out_refund': 'Cash-out échoué (recrédit)',
    ...
    'en_US': {
      // Missing-key sweep 2026-07-31 (raw keys were showing on screen)
      'accept_before_timeout': 'Accept before the timeout expires',
      'accept_delivery': 'Accept delivery',
      'active_delivery': 'Active delivery',
      'address_payment_history': 'Address payment history',
      'address_requests': 'Address requests',
      'arrived': 'Arrived',
      'arrived_at_blood_bank': 'Arrived at blood bank',
      'arrived_at_hospital': 'Arrived at hospital',
      'at_blood_bank': 'At blood bank',
      'at_hospital': 'At hospital',
      'blood_picked_up': 'Blood picked up',
      'call': 'Call',
      'confirm_delivery_message': 'Do you confirm you received the blood delivery?',
      ...
      'en_route_to_blood_bank': 'En route to blood bank',
      'en_route_to_hospital': 'En route to hospital',
      'error_confirming_delivery': 'Error confirming delivery',
      'error_updating_status': 'Error updating status',
      'error_with_message': 'Error: @error',
      'eta': 'ETA',
      'failed': 'Failed',
      'gallery_access_error': 'Could not access the gallery',
      'going_to_blood_bank': 'Going to blood bank',
      'in_transit': 'In transit',
      'inactive_donors': 'Inactive donors',
      'inactive_donors_count': 'Inactive donors',
      'incoming_delivery': 'Incoming delivery',
      'ins_button_what': 'What is INS?',
      'ins_button_yes': 'Yes, I want INS',
      'ins_explain_body': 'The INS (National Health Identifier) is a unique identifier that secures your medical record and simplifies your care across all health facilities.',
      'ins_explain_hint': 'You can always request it later from your profile.',
      'ins_explain_title': 'About INS',
      ...
      'no_address_requests': 'No address requests',
      'no_address_requests_desc': 'Your paid address requests for today will appear here',
      'no_form_fields': 'No form fields to display',
      'no_hospital_selected': 'No hospital selected',
      'no_pending_deliveries': 'No pending deliveries',
      'no_pending_deliveries_desc': 'Your pending deliveries will appear here',
      'no_transactions': 'No transactions',
      'no_transactions_desc': 'Your recent transactions will appear here',
      ...
      'photo_must_show_clear_face': 'The photo must clearly show your face',
      'pickup': 'Pickup',
      'pickup_location': 'Pickup location',
      'preparing_for_dispatch': 'Preparing for dispatch',
      'qr_capture_failed': 'QR code capture failed',
      'qr_download_failed': 'QR code download failed',
      'qr_extraction_not_implemented': 'QR code extraction is not available yet',
      ...
      'validity_duration_config_coming': 'Validity duration configuration coming soon',
      'version': 'Version',
      'visitor': 'Visitor',
      'waiting_for_confirmation': 'Waiting for confirmation',
      'add_stock_to_start': 'Add stock to get started',
      'app_settings': 'App settings',
      'blood_collected': 'Blood Collected',
      'blood_distributed': 'Blood Distributed',
      'blood_product_pricing': 'Blood Product Pricing',
      'blood_stock': 'Blood Stock',
      'blood_types': 'blood types',
      'blood_units_per_period': 'Blood units per @period',
      'clear': 'Clear',
      'clear_cache': 'Clear cache',
      'collected': 'Collected',
      'collection_date': 'Collection date',
      'configure_stock_management': 'Configure stock management settings',
      'contact_info': 'Contact information',
      'critical': 'Critical',
      'critical_stock': 'Critical Stock',
      'critical_stock_alerts': 'Critical stock alerts',
      'critical_stock_alerts_description': 'Receive notifications when stock is low',
      'critical_stock_alerts_disabled': 'Critical stock alerts: disabled',
      'critical_stock_alerts_enabled': 'Critical stock alerts: enabled',
      'critical_stock_thresholds': 'Critical Stock Thresholds',
      'critical_threshold': 'Critical threshold',
      'critical_types': 'Critical Types',
      'current_stock_status': 'Current stock status by blood group',
      'daily_average': 'Daily Average',
      'daily_notifications': 'Daily notifications',
      'daily_notifications_disabled': 'Daily notifications: disabled',
      'daily_notifications_enabled': 'Daily notifications: enabled',
      'daily_summary_description': 'Receive a daily summary of stock status',
      'data_loading_error': 'Error loading data: @error',
      'day': 'day',
      'distributed': 'Distributed',
      'edit_price': 'Edit price of @product',
      'edit_threshold': 'Edit critical threshold @bloodType',
      'evolution': 'Trend',
      ...
      'general_settings_note': 'General app settings (theme, language, etc.) are available in the Profile tab.',
      'hide_details': 'Hide details',
      'in_7_days': 'in 7 days',
      'invalid_email': 'Invalid email',
      'invalid_phone': 'Invalid phone number',
      'inventory_analysis': 'Analysis of your inventory and trends',
      'inventory_report': 'Inventory Report',
      'inventory_reports': 'Inventory Reports',
      'inventory_settings': 'Inventory Settings',
      'just_now': 'Just now',
      'key_metrics': 'Key Metrics',
      'less_than_10_units': '< 10 units',
      ...
      'no_stock_to_display': 'No stock to display',
      'notification_settings': 'Notification Settings',
      'parameters': 'Settings',
      'pending': 'pending',
      'period': 'period',
      'price_currency': 'Price (@currency)',
      'price_update_error': 'Error updating the price',
      'price_updated': 'Price updated for @product',
      'quality_volume': 'Quality: @quality • @volume ml',
      'quarter': 'quarter',
      'quick_statistics': 'Quick Statistics',
      'reports': 'Reports',
      'search_stock': 'Search stock...',
      'setting_updated': 'Setting updated',
      'stock_entries_exits': 'Stock entries and exits this month',
      'stock_summary': 'Stock Summary',
      'threshold_units': 'Threshold (units)',
      'threshold_update_error': 'Error updating the threshold',
      'threshold_updated': 'Threshold updated for @bloodType',
      'transaction_report': 'Transaction Report',
      'unable_to_load_settings': 'Unable to load settings.',
      ...
      'eblood_fee_label': 'eBlood fee',
      'km_delivery_fee': 'Distance fee',
      'km_delivery_fee_with_distance': 'Distance fee (@distance km)',
      ...
      'select_payout_number': 'Select the cash-out number',
      'no_validated_payout_number': 'No validated cash-out number. Add a number in the settings and wait for its validation by eBlood.',
      'cash_outs_title': 'Cash-outs',
      'no_cash_outs': 'No cash-out for this wallet',
      'withdrawal_submitted': 'Withdrawal request submitted',
      'cash_out_status_pending': 'Pending',
      'cash_out_status_processing': 'Processing',
      'cash_out_status_withdrawn': 'Withdrawn',
      'cash_out_status_failed': 'Failed',
      'cash_out_status_rejected': 'Rejected',
      'auto': 'auto',
      'payout_numbers_title': 'Cash-out numbers',
      'add_payout_number': 'Add a number',
      'edit_payout_number': 'Edit number',
      'no_payout_numbers': 'No cash-out number registered',
      'payout_number_validation_note': 'A new or edited number is submitted for eBlood validation',
      'payout_status_pending': 'Pending validation',
      'payout_status_validated': 'Validated',
      'payout_status_rejected': 'Rejected',
      'payout_status_disabled': 'Disabled',
      'holder_name': 'Holder name',
      'operator': 'Operator',
      'daily_cap': 'Daily cap',
      'enter_valid_daily_cap': 'Please enter a valid daily cap (> 0)',
      'enter_valid_priority': 'Please enter a valid priority (≥ 1)',
      'disable': 'Disable',
      'payout_number_saved': 'Number saved and submitted for validation',
      'payout_number_deleted': 'Number deleted',
      'payout_number_disabled': 'Number disabled',
      'confirm_delete_payout_number': 'Are you sure you want to delete this cash-out number?',
      'wallet_origin_blood_request_payment_hold': 'Payment held (escrow)',
      'wallet_origin_blood_request_escrow_release': 'Escrow release',
      'wallet_origin_blood_bag_sale': 'Blood bag sale',
      'wallet_origin_cnts_commission': 'CNTS commission',
      'wallet_origin_platform_flat_fee': 'Platform flat fee',
      'wallet_origin_platform_percent_fee': 'Platform fee (%)',
      'wallet_origin_km_delivery_fee': 'Delivery mileage fee',
      'wallet_origin_blood_request_refund': 'Refund',
      'wallet_origin_cash_out_debit': 'Cash-out',
      'wallet_origin_cash_out_refund': 'Failed cash-out (refunded)',
    ...
    'es_ES': {
      // Missing-key sweep 2026-07-31 (raw keys were showing on screen)
      'accept_before_timeout': 'Acepte antes de que expire el tiempo',
      'accept_delivery': 'Aceptar la entrega',
      'active_delivery': 'Entrega en curso',
      'address_payment_history': 'Historial de pagos de dirección',
      'address_requests': 'Solicitudes de dirección',
      'arrived': 'Llegó',
      'arrived_at_blood_bank': 'Llegó al banco de sangre',
      'arrived_at_hospital': 'Llegó al hospital',
      'at_blood_bank': 'En el banco de sangre',
      'at_hospital': 'En el hospital',
      'blood_picked_up': 'Sangre recogida',
      'call': 'Llamar',
      'confirm_delivery_message': '¿Confirma que recibió la entrega de sangre?',
      'confirm_delivery_receipt': 'Confirmar recepción de la entrega',
      ...
      'delivery_arrived': 'Entrega llegó',
      'delivery_driver': 'Repartidor',
      'delivery_en_route': 'Entrega en camino',
      'delivery_location': 'Lugar de entrega',
      'delivery_progress': 'Progreso de la entrega',
      'demographics': 'Datos demográficos',
      'destination': 'Destino',
      'eligibility': 'Elegibilidad',
      'eligible': 'Elegible',
      'emergency_delivery': 'Entrega de emergencia',
      'en_route_to_blood_bank': 'En camino al banco de sangre',
      'en_route_to_hospital': 'En camino al hospital',
      'error_confirming_delivery': 'Error al confirmar la entrega',
      'error_updating_status': 'Error al actualizar el estado',
      'error_with_message': 'Error: @error',
      'eta': 'Hora estimada de llegada',
      'failed': 'Fallido',
      'gallery_access_error': 'No se pudo acceder a la galería',
      'going_to_blood_bank': 'Yendo al banco de sangre',
      'in_transit': 'En tránsito',
      'inactive_donors': 'Donantes inactivos',
      'inactive_donors_count': 'Donantes inactivos',
      'incoming_delivery': 'Entrega entrante',
      'ins_button_what': '¿Qué es el INS?',
      'ins_button_yes': 'Sí, quiero el INS',
      'ins_explain_body': 'El INS (Identificador Nacional de Salud) es un identificador único que protege su historial médico y facilita su atención en todos los centros de salud.',
      'ins_explain_hint': 'Siempre podrá solicitarlo más tarde desde su perfil.',
      'ins_explain_title': 'Acerca del INS',
      'invalid_latitude': 'Latitud no válida',
      'invalid_longitude': 'Longitud no válida',
      'locations_loading': 'Cargando ubicaciones...',
      'map_view': 'Vista de mapa',
      'max_length': 'Longitud máxima',
      'min_length': 'Longitud mínima',
      'my_activity': 'Mi actividad',
      'new_delivery_request': 'Nueva solicitud de entrega',
      'no_active_delivery': 'Sin entrega en curso',
      'no_address_requests': 'Sin solicitudes de dirección',
      'no_address_requests_desc': 'Sus solicitudes de dirección pagadas de hoy aparecerán aquí',
      'no_form_fields': 'No hay campos de formulario para mostrar',
      'no_hospital_selected': 'Ningún hospital seleccionado',
      'no_pending_deliveries': 'Sin entregas pendientes',
      'no_pending_deliveries_desc': 'Sus entregas pendientes aparecerán aquí',
      'no_transactions': 'Sin transacciones',
      'no_transactions_desc': 'Sus transacciones recientes aparecerán aquí',
      ...
      'photo_must_show_clear_face': 'La foto debe mostrar claramente su rostro',
      'pickup': 'Recogida',
      'pickup_location': 'Lugar de recogida',
      'preparing_for_dispatch': 'Preparando para el envío',
      'qr_capture_failed': 'Error al capturar el código QR',
      'qr_download_failed': 'Error al descargar el código QR',
      'qr_extraction_not_implemented': 'La extracción del código QR aún no está disponible',
      'qr_saved': 'Código QR guardado',
      'recent_transactions': 'Transacciones recientes',
      'region': 'Región',
      'registration_error': 'Error de registro',
      'reject': 'Rechazar',
      'something_wrong_try_again': 'Algo salió mal. Inténtelo de nuevo.',
      'start_delivery': 'Iniciar entrega',
      'status_updated': 'Estado actualizado',
      'successfully_delivered': 'Entregado con éxito',
      'support_coming_soon': 'Soporte disponible pronto',
      'switch': 'Cambiar',
      'total': 'Total',
      'track': 'Seguir',
      'transactions': 'Transacciones',
      'try_different_location': 'Pruebe otra ubicación',
      'update_status': 'Actualizar estado',
      'validation_failed': 'Error de validación',
      'validity_duration_config_coming': 'La configuración de la duración de validez llegará pronto',
      'version': 'Versión',
      'visitor': 'Visitante',
      ...
      'select_payout_number': 'Seleccione el número de retiro',
      'no_validated_payout_number': 'Ningún número de retiro validado. Agregue un número en la configuración y espere su validación por eBlood.',
      'cash_outs_title': 'Retiros',
      'no_cash_outs': 'Ningún retiro para esta billetera',
      'withdrawal_submitted': 'Solicitud de retiro enviada',
      'cash_out_status_pending': 'Pendiente',
      'cash_out_status_processing': 'En proceso',
      'cash_out_status_withdrawn': 'Retirado',
      'cash_out_status_failed': 'Fallido',
      'cash_out_status_rejected': 'Rechazado',
      'auto': 'auto',
      'payout_numbers_title': 'Números de retiro',
      'add_payout_number': 'Agregar un número',
      'edit_payout_number': 'Editar el número',
      'no_payout_numbers': 'Ningún número de retiro registrado',
      'payout_number_validation_note': 'Un número nuevo o modificado se envía a la validación de eBlood',
      'payout_status_pending': 'Pendiente de validación',
      'payout_status_validated': 'Validado',
      'payout_status_rejected': 'Rechazado',
      'payout_status_disabled': 'Desactivado',
      'holder_name': 'Nombre del titular',
      'operator': 'Operador',
      'daily_cap': 'Límite diario',
      'priority': 'Prioridad',
      'enter_valid_daily_cap': 'Ingrese un límite diario válido (> 0)',
      'enter_valid_priority': 'Ingrese una prioridad válida (≥ 1)',
      'disable': 'Desactivar',
      'payout_number_saved': 'Número guardado y enviado a validación',
      'payout_number_deleted': 'Número eliminado',
      'payout_number_disabled': 'Número desactivado',
      'confirm_delete_payout_number': '¿Está seguro de que desea eliminar este número de retiro?',
      'other': 'Otro',
      'phone_number': 'Número de teléfono',
      'wallet_origin_blood_request_payment_hold': 'Pago retenido (depósito en garantía)',
      'wallet_origin_blood_request_escrow_release': 'Liberación del depósito en garantía',
      'wallet_origin_blood_bag_sale': 'Venta de bolsas de sangre',
      'wallet_origin_cnts_commission': 'Comisión CNTS',
      'wallet_origin_platform_flat_fee': 'Tarifa fija de la plataforma',
      'wallet_origin_platform_percent_fee': 'Tarifa de la plataforma (%)',
      'wallet_origin_km_delivery_fee': 'Tarifa por kilometraje de entrega',
      'wallet_origin_blood_request_refund': 'Reembolso',
      'wallet_origin_cash_out_debit': 'Retiro de efectivo',
      'wallet_origin_cash_out_refund': 'Retiro fallido (reacreditado)',
      ...
      'eblood_fee_label': 'Tarifa eBlood',
      'km_delivery_fee': 'Tarifa por distancia',
      'km_delivery_fee_with_distance': 'Tarifa por distancia (@distance km)',
      ...
      'password_needs_digit': 'La contraseña debe contener al menos un dígito',
      'password_needs_special': 'La contraseña debe contener al menos un carácter especial',
      'locked': 'Bloqueado',
      'revoqued': 'Revocado',
      'unlock': 'Desbloquear',
      'lock': 'Bloquear',
    ...
    'ln_CD': {
      // Missing-key sweep 2026-07-31 (raw keys were showing on screen)
      'accept_before_timeout': 'Ndima liboso tango esila',
      'accept_delivery': 'Ndima kokomisa',
      'active_delivery': 'Kokomisa ezali kosalema',
      'address_payment_history': 'Histoire ya bafuti ya adresse',
      'address_requests': 'Bisengeli ya adresse',
      'arrived': 'Akomi',
      'arrived_at_blood_bank': 'Akomi na banke ya makila',
      'arrived_at_hospital': 'Akomi na lopitalo',
      'at_blood_bank': 'Na banke ya makila',
      'at_hospital': 'Na lopitalo',
      'blood_picked_up': 'Makila ezwami',
      'call': 'Benga',
      'confirm_delivery_message': 'Ondimi ete ozwi makila oyo ememelaki yo?',
      'confirm_delivery_receipt': 'Ndima bozwi ya kokomisa',
      'confirm_receipt': 'Ndima bozwi',
      'confirming': 'Kondima...',
      'current': 'Ya sikawa',
      'customer': 'Kiliya',
      'date': 'Mokolo',
      'delivery': 'Kokomisa',
      'delivery_accepted': 'Kokomisa endimami',
      'delivery_arrived': 'Kokomisa ekomi',
      'delivery_driver': 'Momemi',
      'delivery_en_route': 'Kokomisa ezali na nzela',
      'delivery_location': 'Esika ya kokomisa',
      'delivery_progress': 'Botamboli ya kokomisa',
      'demographics': 'Basango ya bato',
      'destination': 'Esika ya kokende',
      'eligibility': 'Bokoki',
      'eligible': 'Akoki',
      'emergency_delivery': 'Kokomisa ya lombangu',
      'en_route_to_blood_bank': 'Na nzela ya banke ya makila',
      'en_route_to_hospital': 'Na nzela ya lopitalo',
      'error_confirming_delivery': 'Libunga na kondima kokomisa',
      'error_updating_status': 'Libunga na kobongola état',
      'error_with_message': 'Libunga: @error',
      'eta': 'Ngonga ya kokoma',
      'failed': 'Elongi te',
      'gallery_access_error': 'Ekoki kofungola galerie te',
      'going_to_blood_bank': 'Azali kokende na banke ya makila',
      'in_transit': 'Na nzela',
      'inactive_donors': 'Bapesi makila oyo basali lisusu te',
      'inactive_donors_count': 'Bapesi makila oyo basali lisusu te',
      'incoming_delivery': 'Kokomisa ezali koya',
      'ins_button_what': 'INS ezali nini?',
      'ins_button_yes': 'Iyo, nalingi INS',
      'ins_explain_body': 'INS (Nimero ya Kokangama na Santé) ezali nimero ya yo moko oyo ebatelaka dossier médical na yo mpe esalisaka yo na balopitalo nyonso.',
      'ins_explain_hint': 'Okoki kosenga yango sima na profil na yo.',
      'ins_explain_title': 'Mpo na INS',
      'invalid_latitude': 'Latitude ezali mabe',
      'invalid_longitude': 'Longitude ezali mabe',
      'locations_loading': 'Bisika ezali kokota...',
      'map_view': 'Botali ya karte',
      'max_length': 'Molai ya suka',
      'min_length': 'Molai ya moke',
      'my_activity': 'Misala na ngai',
      'new_delivery_request': 'Bosengi ya sika ya kokomisa',
      'no_active_delivery': 'Kokomisa moko te ezali kosalema',
      'no_address_requests': 'Bisengeli ya adresse ezali te',
      'no_address_requests_desc': 'Bisengeli ya adresse oyo ofuti lelo ekomonana awa',
      'no_form_fields': 'Bisika ya formulaire ezali te',
      'no_hospital_selected': 'Lopitalo moko te eponami',
      'no_pending_deliveries': 'Kokomisa moko te ezali kozela',
      'no_pending_deliveries_desc': 'Kokomisa na yo oyo ezali kozela ekomonana awa',
      'no_transactions': 'Transaction moko te',
      'no_transactions_desc': 'Batransaction na yo ya sika ekomonana awa',
      'not_specified': 'Elimbolami te',
      'on_the_way': 'Na nzela',
      'optional': 'Esengeli te',
      'order_id': 'Nimero ya commande',
      'order_pending': 'Commande ezali kozela',
      'passwords_do_not_match': 'Bamots de passe ekokani te',
      'pending_deliveries': 'Kokomisa oyo ezali kozela',
      'photo_must_show_clear_face': 'Fotó esengeli elakisa elongi na yo polele',
      'pickup': 'Bozwi',
      'pickup_location': 'Esika ya bozwi',
      'preparing_for_dispatch': 'Kobongisa mpo na kotinda',
      'qr_capture_failed': 'Kozwa code QR elongi te',
      'qr_download_failed': 'Kokitisa code QR elongi te',
      'qr_extraction_not_implemented': 'Kobimisa code QR ezali naino te',
      'qr_saved': 'Code QR ebombami',
      'recent_transactions': 'Batransaction ya sika',
      'region': 'Etuka',
      'registration_error': 'Libunga na bokomisi nkombo',
      'reject': 'Boya',
      'something_wrong_try_again': 'Likambo moko ebebi. Meka lisusu.',
      'start_delivery': 'Banda kokomisa',
      'status_updated': 'État ebongwani',
      'successfully_delivered': 'Ekomisami malamu',
      'support_coming_soon': 'Lisalisi ekoya kala mingi te',
      'switch': 'Bongola',
      'total': 'Motango mobimba',
      'track': 'Landela',
      'transactions': 'Batransaction',
      'try_different_location': 'Meka esika mosusu',
      'update_status': 'Bongola état',
      'validation_failed': 'Validation elongi te',
      'validity_duration_config_coming': 'Kobongisa tango ya validité ekoya kala mingi te',
      'version': 'Version',
      'visitor': 'Mopaya',
      'waiting_for_confirmation': 'Kozela bondimi',
      ...
      'eblood_fee_label': 'Frais ya eBlood',
      'km_delivery_fee': 'Frais ya ntaka',
      'km_delivery_fee_with_distance': 'Frais ya ntaka (@distance km)',
      ...
      'select_payout_number': 'Pona nimero ya kobimisa mbongo',
      'no_validated_payout_number': 'Nimero ya kobimisa mbongo oyo endimami ezali te. Bakisa nimero na paramètres mpe zela kondimama na eBlood.',
      'cash_outs_title': 'Bobimisi ya mbongo',
      'no_cash_outs': 'Bobimisi ya mbongo ezali te mpo na portefeuille oyo',
      'withdrawal_submitted': 'Bosenga ya kobimisa mbongo etindami',
      'cash_out_status_pending': 'Ezali kozela',
      'cash_out_status_processing': 'Ezali kosalema',
      'cash_out_status_withdrawn': 'Ebimisami',
      'cash_out_status_failed': 'Elongi te',
      'cash_out_status_rejected': 'Eboyami',
      'auto': 'auto',
      'refresh': 'Kozongisa sika',
      'payout_numbers_title': 'Banimero ya kobimisa mbongo',
      'add_payout_number': 'Bakisa nimero',
      'edit_payout_number': 'Bongola nimero',
      'no_payout_numbers': 'Nimero ya kobimisa mbongo ezali te',
      'payout_number_validation_note': 'Nimero ya sika to oyo ebongwani etindami mpo na kondimama na eBlood',
      'payout_status_pending': 'Ezali kozela kondimama',
      'payout_status_validated': 'Endimami',
      'payout_status_rejected': 'Eboyami',
      'payout_status_disabled': 'Ekangami',
      'holder_name': 'Nkombo ya nkolo',
      'operator': 'Opérateur',
      'daily_cap': 'Ndelo ya mokolo',
      'priority': 'Priorité',
      'enter_valid_daily_cap': 'Kotia ndelo ya mokolo ya solo (> 0)',
      'enter_valid_priority': 'Kotia priorité ya solo (≥ 1)',
      'disable': 'Kokanga',
      'payout_number_saved': 'Nimero ebombami mpe etindami mpo na kondimama',
      'payout_number_deleted': 'Nimero elongolami',
      'payout_number_disabled': 'Nimero ekangami',
      'confirm_delete_payout_number': 'Ozali na ntembe ya kolongola nimero oyo ya kobimisa mbongo?',
      'other': 'Mosusu',
      'phone_number': 'Nimero ya telefone',
      'wallet_origin_blood_request_payment_hold': 'Mbongo ekangami (séquestre)',
      'wallet_origin_blood_request_escrow_release': 'Mbongo oyo ekangamaki ebimisami',
      'wallet_origin_blood_bag_sale': 'Koteka saki ya makila',
      'wallet_origin_cnts_commission': 'Comission ya CNTS',
      'wallet_origin_platform_flat_fee': 'Frais ya plateforme (fixe)',
      'wallet_origin_platform_percent_fee': 'Frais ya plateforme (%)',
      'wallet_origin_km_delivery_fee': 'Frais ya kilomlongwa ya livraison',
      'wallet_origin_blood_request_refund': 'Kozongisa mbongo',
      'wallet_origin_cash_out_debit': 'Kobimisa mbongo (cash-out)',
      'wallet_origin_cash_out_refund': 'Cash-out esali te (mbongo ezongi)',
      ...
      'password_required': 'Mot de passe esengeli',
      'password_min_length': 'Mot de passe esengeli ezala na ba caractères 8 to koleka',
      'password_needs_uppercase': 'Mot de passe esengeli ezala na lettre majuscule moko',
      'password_needs_lowercase': 'Mot de passe esengeli ezala na lettre minuscule moko',
      'password_needs_digit': 'Mot de passe esengeli ezala na chiffre moko',
      'password_needs_special': 'Mot de passe esengeli ezala na caractère spécial moko',
      'locked': 'Ekangami',
      'revoqued': 'Elongolami',
      'unlock': 'Fungola',
      'lock': 'Kanga',
    ...
    'ru_RU': {
      // Missing-key sweep 2026-07-31 (raw keys were showing on screen)
      'accept_before_timeout': 'Примите до истечения времени',
      'accept_delivery': 'Принять доставку',
      'active_delivery': 'Активная доставка',
      'address_payment_history': 'История оплат адресов',
      'address_requests': 'Запросы адресов',
      'arrived': 'Прибыл',
      'arrived_at_blood_bank': 'Прибыл в банк крови',
      'arrived_at_hospital': 'Прибыл в больницу',
      'at_blood_bank': 'В банке крови',
      'at_hospital': 'В больнице',
      'blood_picked_up': 'Кровь получена',
      'call': 'Позвонить',
      'confirm_delivery_message': 'Подтверждаете получение доставки крови?',
      'confirm_delivery_receipt': 'Подтвердить получение доставки',
      ...
      'delivery_driver': 'Курьер',
      'delivery_en_route': 'Доставка в пути',
      'delivery_location': 'Место доставки',
      'delivery_progress': 'Ход доставки',
      'demographics': 'Демография',
      'destination': 'Пункт назначения',
      'eligibility': 'Право на участие',
      'eligible': 'Подходит',
      'emergency_delivery': 'Экстренная доставка',
      'en_route_to_blood_bank': 'В пути в банк крови',
      'en_route_to_hospital': 'В пути в больницу',
      'error_confirming_delivery': 'Ошибка подтверждения доставки',
      'error_updating_status': 'Ошибка обновления статуса',
      'error_with_message': 'Ошибка: @error',
      'eta': 'Ожидаемое время прибытия',
      'failed': 'Не удалось',
      'gallery_access_error': 'Не удалось открыть галерею',
      'going_to_blood_bank': 'Направляется в банк крови',
      'in_transit': 'В пути',
      'inactive_donors': 'Неактивные доноры',
      'inactive_donors_count': 'Неактивные доноры',
      'incoming_delivery': 'Входящая доставка',
      'ins_button_what': 'Что такое INS?',
      'ins_button_yes': 'Да, я хочу INS',
      'ins_explain_body': 'INS (Национальный идентификатор здоровья) — это уникальный идентификатор, который защищает вашу медицинскую карту и упрощает обслуживание во всех медицинских учреждениях.',
      'ins_explain_hint': 'Вы всегда сможете запросить его позже из своего профиля.',
      'ins_explain_title': 'Об INS',
      'invalid_latitude': 'Неверная широта',
      'invalid_longitude': 'Неверная долгота',
      'locations_loading': 'Загрузка местоположений...',
      'map_view': 'Вид карты',
      'max_length': 'Максимальная длина',
      'min_length': 'Минимальная длина',
      'my_activity': 'Моя активность',
      'new_delivery_request': 'Новый запрос на доставку',
      'no_active_delivery': 'Нет активных доставок',
      'no_address_requests': 'Нет запросов адресов',
      'no_address_requests_desc': 'Ваши оплаченные сегодня запросы адресов появятся здесь',
      'no_form_fields': 'Нет полей формы для отображения',
      'no_hospital_selected': 'Больница не выбрана',
      'no_pending_deliveries': 'Нет ожидающих доставок',
      'no_pending_deliveries_desc': 'Ваши ожидающие доставки появятся здесь',
      'no_transactions': 'Нет транзакций',
      'no_transactions_desc': 'Ваши недавние транзакции появятся здесь',
      'not_specified': 'Не указано',
      'on_the_way': 'В пути',
      'optional': 'Необязательно',
      'order_id': 'Номер заказа',
      'order_pending': 'Заказ в ожидании',
      'passwords_do_not_match': 'Пароли не совпадают',
      'pending_deliveries': 'Ожидающие доставки',
      'photo_must_show_clear_face': 'На фото должно быть чётко видно ваше лицо',
      'pickup': 'Получение',
      'pickup_location': 'Место получения',
      'preparing_for_dispatch': 'Подготовка к отправке',
      'qr_capture_failed': 'Не удалось захватить QR-код',
      'qr_download_failed': 'Не удалось скачать QR-код',
      'qr_extraction_not_implemented': 'Извлечение QR-кода пока недоступно',
      'qr_saved': 'QR-код сохранён',
      'recent_transactions': 'Недавние транзакции',
      'region': 'Регион',
      'registration_error': 'Ошибка регистрации',
      'reject': 'Отклонить',
      'something_wrong_try_again': 'Что-то пошло не так. Попробуйте ещё раз.',
      ...
      'try_different_location': 'Попробуйте другое место',
      'update_status': 'Обновить статус',
      'validation_failed': 'Ошибка валидации',
      'validity_duration_config_coming': 'Настройка срока действия скоро появится',
      'version': 'Версия',
      'visitor': 'Посетитель',
      ...
      'eblood_fee_label': 'Сбор eBlood',
      'km_delivery_fee': 'Плата за расстояние',
      'km_delivery_fee_with_distance': 'Плата за расстояние (@distance km)',
      ...
      'select_payout_number': 'Выберите номер для вывода',
      'no_validated_payout_number': 'Нет подтверждённого номера для вывода. Добавьте номер в настройках и дождитесь его проверки eBlood.',
      'cash_outs_title': 'Выводы средств',
      'no_cash_outs': 'Выводов средств по этому кошельку нет',
      'withdrawal_submitted': 'Запрос на вывод отправлен',
      'cash_out_status_pending': 'В ожидании',
      'cash_out_status_processing': 'В обработке',
      'cash_out_status_withdrawn': 'Выведено',
      'cash_out_status_failed': 'Не удалось',
      'cash_out_status_rejected': 'Отклонено',
      'auto': 'авто',
      'payout_numbers_title': 'Номера для вывода',
      'add_payout_number': 'Добавить номер',
      'edit_payout_number': 'Изменить номер',
      'no_payout_numbers': 'Номера для вывода не зарегистрированы',
      'payout_number_validation_note': 'Новый или изменённый номер отправляется на проверку eBlood',
      'payout_status_pending': 'Ожидает проверки',
      'payout_status_validated': 'Подтверждён',
      'payout_status_rejected': 'Отклонён',
      'payout_status_disabled': 'Отключён',
      'holder_name': 'Имя владельца',
      'operator': 'Оператор',
      'daily_cap': 'Дневной лимит',
      'priority': 'Приоритет',
      'enter_valid_daily_cap': 'Введите корректный дневной лимит (> 0)',
      'enter_valid_priority': 'Введите корректный приоритет (≥ 1)',
      'disable': 'Отключить',
      'payout_number_saved': 'Номер сохранён и отправлен на проверку',
      'payout_number_deleted': 'Номер удалён',
      'payout_number_disabled': 'Номер отключён',
      'confirm_delete_payout_number': 'Вы действительно хотите удалить этот номер для вывода?',
      'wallet_origin_blood_request_payment_hold': 'Платёж заблокирован (эскроу)',
      'wallet_origin_blood_request_escrow_release': 'Освобождение из эскроу',
      'wallet_origin_blood_bag_sale': 'Продажа пакетов крови',
      'wallet_origin_cnts_commission': 'Комиссия CNTS',
      'wallet_origin_platform_flat_fee': 'Фиксированная комиссия платформы',
      'wallet_origin_platform_percent_fee': 'Комиссия платформы (%)',
      'wallet_origin_km_delivery_fee': 'Плата за доставку (км)',
      'wallet_origin_blood_request_refund': 'Возврат средств',
      'wallet_origin_cash_out_debit': 'Вывод средств',
      'wallet_origin_cash_out_refund': 'Неудачный вывод (возврат средств)',
      ...
      'password_needs_special': 'Пароль должен содержать хотя бы один специальный символ',
