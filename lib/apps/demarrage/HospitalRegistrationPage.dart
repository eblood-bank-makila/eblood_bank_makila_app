...
class HospitalRegistrationPage extends StatefulWidget {
  ...
  @override
  State<HospitalRegistrationPage> createState() => _HospitalRegistrationPageState();
}
...
class _HospitalRegistrationPageState extends State<HospitalRegistrationPage> {
  ...
  void _handleRegistration() async {
    ...
    try {
      ...
      Get.snackbar(
        'Success',
        'Hospital registration successful! Please check your email for verification.',
        snackPosition: SnackPosition.BOTTOM,
